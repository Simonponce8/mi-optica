...
export default function EditarFicha() {
  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      const { data: ficha } = await supabase.from("fichas_opticas").select("*").eq("id", params.id).single();
      if (ficha) {
        setClienteId(ficha.cliente_id);
        setForm({
          fecha_examen: ficha.fecha_examen || "",
          doctor: ficha.doctor || "",
          od_esfera: ficha.od_esfera !== null && ficha.od_esfera !== undefined ? formatGrad(ficha.od_esfera) : "",
          od_cilindro: ficha.od_cilindro !== null && ficha.od_cilindro !== undefined ? formatGrad(ficha.od_cilindro) : "",
          od_eje: ficha.od_eje ?? "",
          av_od_lejos: ficha.av_od_lejos || "",
          oi_esfera: ficha.oi_esfera !== null && ficha.oi_esfera !== undefined ? formatGrad(ficha.oi_esfera) : "",
          oi_cilindro: ficha.oi_cilindro !== null && ficha.oi_cilindro !== undefined ? formatGrad(ficha.oi_cilindro) : "",
          oi_eje: ficha.oi_eje ?? "",
          av_oi_lejos: ficha.av_oi_lejos || "",
          av_ao_lejos: ficha.av_ao_lejos || "",
          od_esfera_cerca: ficha.od_esfera_cerca !== null && ficha.od_esfera_cerca !== undefined ? formatGrad(ficha.od_esfera_cerca) : "",
          od_cilindro_cerca: ficha.od_cilindro_cerca !== null && ficha.od_cilindro_cerca !== undefined ? formatGrad(ficha.od_cilindro_cerca) : "",
          od_eje_cerca: ficha.od_eje_cerca ?? "",
          av_od_cerca: ficha.av_od_cerca || "",
          oi_esfera_cerca: ficha.oi_esfera_cerca !== null && ficha.oi_esfera_cerca !== undefined ? formatGrad(ficha.oi_esfera_cerca) : "",
          oi_cilindro_cerca: ficha.oi_cilindro_cerca !== null && ficha.oi_cilindro_cerca !== undefined ? formatGrad(ficha.oi_cilindro_cerca) : "",
          oi_eje_cerca: ficha.oi_eje_cerca ?? "",
          av_oi_cerca: ficha.av_oi_cerca || "",
          av_ao_cerca: ficha.av_ao_cerca || "",
          stock: ficha.stock || "",
          laboratorio: ficha.laboratorio || "",
          marca: ficha.marca || "",
          anteojo_cerca: ficha.anteojo_cerca || "",
          monto_total: ficha.monto_total ?? "",
          sena: ficha.sena ?? "",
  ...
  const saldo = () => {
    ...
    const sena = parseFloat(form.sena) || 0;
    return total - sena;
  };
  ...
  const handleGuardar = async () => {
    ...
    setLoading(true);
    const datos = { fecha_examen: form.fecha_examen, doctor: form.doctor };
    ...
    datos.stock = form.stock;
    datos.laboratorio = form.laboratorio;
    datos.marca = form.marca;
    datos.anteojo_cerca = form.anteojo_cerca;
    datos.monto_total = parseFloat(form.monto_total) || 0;
    datos.sena = parseFloat(form.sena) || 0;
    datos.observaciones = form.observaciones;
    const { error } = await supabase.from("fichas_opticas").update(datos).eq("id", params.id);
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#f4f7fb" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        <div style={{ background: "#fff", borderBottom: "1px solid #dde3ec", padding: "14px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: "15px", fontWeight: "600", color: "#1e3a5f" }}>Editar ficha optica</span>
            ...
            <div style={{ borderTop: "1px solid #f0f2f5", paddingTop: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", alignItems: "end" }}>
                ...
                <div>
                  ...
                  <div style={{ padding: "8px 12px", border: "1px solid #dde3ec", borderRadius: "6px", fontSize: "14px", background: "#f4f7fb", fontWeight: "600", color: saldoCalc > 0 ? "#854F0B" : "#27500A" }}>
                    ${saldoCalc.toLocaleString("es-AR")}
                  </div>
                </div>
              </div>
              <div style={{ marginTop: "12px" }}>
                <span style={{ padding: "6px 16px", borderRadius: "20px", fontSize: "13px", fontWeight: "600", background: saldoCalc > 0 ? "#FAEEDA" : "#EAF3DE", color: saldoCalc > 0 ? "#854F0B" : "#27500A" }}>
                  {saldoCalc > 0 ? "PENDIENTE" : "PAGADO"}
                </span>
              </div>
            </div>
